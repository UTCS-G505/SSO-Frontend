<template>
  <div class="about-container">
    <!-- App Header with logo and UserMenu -->
    <AppHeader />
    ...
    <main class="about-section">
      ...
      <section class="about-content">
        ...
        <p>一、 蒐集個人資料之目的</p>
        <p>本系為執行資源利用與服務推廣相關業務所需，蒐集您的個人資料。</p>
        <p>二、 蒐集個人資料之類別</p>
        <ol>
          <li>
        ...
        <p>您可依個資法第三條規定，就本系保有您的個人資料行使以下權利：</p>
        <ol>
          <li>請求查詢或閱覽。</li>
          <li>請求製給複製本。</li>
          <li>請求補充或更正。</li>
        ...
        <p>若您欲執行上述權利，或有任何建議指教，請與本系連繫。</p>
        <p>本系個人資料保護申訴窗口為資訊科學系系辦。</p>
        <p>七、 同意書之效力</p>
        <p>當您完成簽署時，即表示您已閱讀瞭解並同意本同意書的內容。</p>
        <p>
          本系保留隨時修改本同意書之權利，內容修改時將於本系網站公告。如您未於公告後一個月內提出異議或仍繼續使用本系相關服務，將視為您已同意並接受本系所更改之內容。
        </p>
        <h3>本系聯絡方式</h3>
        <p>您可以透過下列方式與本系系辦聯絡：</p>
        <ul>
          <li>電話：886-2-23113040 #8362、8363</li>
          <li>電子郵件：<a href="mailto:cs@go.utaipei.edu.tw">cs@go.utaipei.edu.tw</a></li>
        </ul>
      </section>

      <h2 class="title">開發與維護人員名單</h2>
...
import { developerConfig } from '@/config/developers'

const router = useRouter()
const Developers = developerConfig
